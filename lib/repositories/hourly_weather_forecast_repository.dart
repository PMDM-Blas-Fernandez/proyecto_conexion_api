...
class HourlyWeatherForecastRepository {
  ...
  Future<List<HourlyWeatherForecast>> getHourlyWeatherForecast(String ciudad) async {
    try {
      final response = await DataProvider.getRequest(endpoint: "http://api.openweathermap.org/data/2.5/forecast?q=$ciudad&APPID=cebbc1607826198ffbd6d89586625c48&units=metric");
